...
<script type="text/javascript">
    ...
    function OpenRoleActionPage(action, goPage, target, pHeight, pWidth, userID, userRole, appID, modelID, xID, xName, xType) {
        ...
        if ($("#hfUserRole").val() != "Admin") {
            ...
            if (action == "SubFun") {
               var goPage = "Loading2.aspx?pID=" + goPage + "&" + para; // AppRoleManageSub.aspx" + para;
                $("#IframeSubArea").attr('src', goPage);
            }
            else {             
                var para = "?" + para; //UserID=" + userID + "&UserRole=" + userRole + "&AppID=" + appID + "&ModelID=" + modelID + "&xID=" + xID + "&xType=" + xType + "&Action=" + action;
