    ...
    <form id="form1" runat="server">
        ...
        <div class="SearchArea-SchoolRow">
            ...
            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                <ContentTemplate>
                    Apps: 
            <asp:DropDownList ID="ddlApps" runat="server" Width="200px">
            </asp:DropDownList>
                    School:
        ...
        <div class="staff-container" style="margin-top: 5px;">
            <div class="staff-list">
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <div style="overflow: scroll; width: 700px; height: 500px" onscroll="OnScrollDiv(this)" id="DivMainContent">
...
<script type="text/javascript">
    ...
    function OpenGroupNew() {
        var page = "../PagesForms/Security_Group.aspx"
        var schoolyear = $("#hfSchoolYear").val();
        ...
        var groupID = "0";
        var IDs = "0";
        var para = "?SchoolYear=" + schoolyear + "&SchoolCode=" + schoolcode + "&UserID=" + userID + "&UserRole=" + userrole + "&AppID=" + appID + "&GroupID=" + groupID + "&Action=Add" + "&IDs=" + IDs;
        OpenInPage('New Security Group', page, para, groupID);
    }

    function OpenGroupActionPage(userID, userrole, schoolyear, schoolcode, appID, groupID,groupType, action,ids) {
       
        if (action == "SubFun") {
            var para = "&sYear=" + schoolyear + "&sCode=" + schoolcode + "&appID=" + appID + "&xID=" + groupID + "&xType=" + groupType; //+ ""M.GroupType
            var goPage = "Loading2.aspx?pID=GroupManageSub.aspx" + para
            $("#IframeSubArea").attr('src', goPage);
        }
        else {
            var page = "../PagesForms/Security_Group.aspx"
            var para = "?SchoolYear=" + schoolyear + "&SchoolCode=" + schoolcode + "&UserID=" + userID + "&UserRole=" + userrole + "&AppID=" + appID + "&GroupID=" + groupID + "&Action=" + action + "&IDs=" + ids;
