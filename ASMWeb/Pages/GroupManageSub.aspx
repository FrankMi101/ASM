...
<script type="text/javascript">
    ...
    function OpenAddPermission(xType) {
        ...
        var page = "../PagesForms/Permission_Group.aspx";
        ...
        OpenInPage('App User Group Permission', page, arg, para.xID);
    ...
    function OpenPermissionActionPage(action, goPage, target, pHeight, pWidth, userID, userRole, appID, modelID, xID, xType, IDs) {
        ...
        OpenInPage('App User Group Permission', page, arg, xID);

    }


    function OpenInPage(title, page, para, groupId) {
        var goPage = "../PagesForms/" + page + para;
        alert(goPage);
