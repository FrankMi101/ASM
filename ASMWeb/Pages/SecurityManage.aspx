<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SecurityManage.aspx.cs" Inherits="ASM.Pages.SecurityManage" Async="true" %>
...
<script type="text/javascript">
    ...
    function OpenGroupActionPage(userID, userrole, schoolyear, schoolcode, appID, groupID, action,ids) {
       
        if (action == "SubFun") {
            var para = "&sYear=" + schoolyear + "&sCode=" + schoolcode + "&appID=" + appID + "&gID=" + groupID + "&gType=School"; //+ ""M.GroupType
            var goPage = "Loading2.aspx?pID=SecurityManageSub.aspx" + para
