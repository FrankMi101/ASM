...
-- drop  proc dbo.SIC_sys_ListofClasses  '' ,'mif','admin','20202021','0549','Academic','','','School','','1','1'

CREATE   proc [dbo].[SIC_sys_ListofClasses]  
	@Operate		varchar(30),
	@UserID			varchar(30),
...
else if @Grade = 'Academic'
	 begin
		if @Term is null  select @Semester ='1' , @Term ='1'
