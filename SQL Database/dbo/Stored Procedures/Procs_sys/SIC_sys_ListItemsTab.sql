...
CREATE proc [dbo].[SIC_sys_ListItemsTab]   
        @Operate 	varchar(50),
...
begin
	if @Operate =''
 	...
 	else if @Operate = 'RangerTab'
		select 'North' as [Value], 'North Area' as [Name], '2' as orderby
		union
		select 'South' as [Value], 'South Area' as [Name], '3' as orderby
		union
		select 'East' as [Value], 'East Area' as [Name], '4' as orderby
		union
		select 'West' as [Value], 'West Area' as [Name], '5' as orderby
		union
		select 'Center' as [Value], 'Center Area' as [Name], '6' as orderby
		...
		select 'Other' as [Value], 'Other Staff' as [Name], '4' as orderby
			order by orderby, [Value]
	else if @Operate = 'StaffPrincipalTab'
		select 'Principal' as [Value], 'Principal' as [Name], '1' as orderby
		union
		select 'VP' as [Value], 'Vice Principal' as [Name], '2' as orderby
		union
		select 'PreSY' as [Value], 'Pre-SchoolYear' as [Name], '3' as orderby
