...
-- ===================================================================================== 
CREATE  proc [dbo].[SIC_asm_AppUserGroupMemberT_Read]  -- 'GroupListTeacher','mif','Admin','0000','SIC','All Board Schools'
	@Operate		varchar(30),
...
set nocount on
	...
	declare  @SchoolYear varchar(8) ,@Type varchar(20), @ModelID varchar(50)
 	select   @SchoolYear ='20202021', @Type = 'TeacherMember', @ModelID = 'Pages'
