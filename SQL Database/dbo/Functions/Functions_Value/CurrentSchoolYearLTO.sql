...
-- drop function  dbo.CurrentSchoolYearLTO  (getdate())
CREATE FUNCTION [dbo].[CurrentSchoolYearLTO] 
( 
  @date datetime 
)  
RETURNS varchar(8) 
AS  
BEGIN 
	return   [dbo].[Current.SchoolYear]('LTO') --   dbo.CurrentSchoolYear2( @date , 6, 14)
End
