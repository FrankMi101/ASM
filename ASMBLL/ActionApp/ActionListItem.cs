...
namespace ASMBLL
{
    public class ActionListItem : IActionGet<NameValueList> 
    {
       // private IDataOperate<NameValueList> _dataOperate = new DataOperate<NameValueList>();
        private readonly IDataOperateService<NameValueList> _dataOperate = (IDataOperateService<NameValueList>)MapClass<NameValueList>.DBSource(); // new DataOperateService<AppRole>(new DataOperateServiceSQL<AppRole>());
