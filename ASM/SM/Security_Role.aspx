<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Security_Role.aspx.cs" Inherits="ASM.Security_Role" Async="true" %>
...
<script type="text/javascript">
    ...
    function SaveDataToDatabase() {
        try {
            ...
            var result = ASM.Models.WebService.SaveSecurityRole(para.Operate, para, onSuccess, onFailure);
        }
        catch (e) {
