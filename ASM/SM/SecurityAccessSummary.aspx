<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SecurityAccessSummary.aspx.cs" Inherits="ASM.SecurityAccessSummary" %>
    ...
    <form id="form1" runat="server">
        <div class="Content-Text">
            ...
            <div id="Principal_Instration_Area">
                ...
                <br /><b> First</b>,the application will get the User Apps Role, if there is no Apps Role defined, the SAP matched default role instead. 
                <br /><b>Second </b>, application gets the user access students scope based on the user Role. it will be school, class, grade, students.
               <br /><b>Thrid</b>, application will decide the which function and operation user can take based on the Role and Students, it could be a Read, update, Super.  
               <br /> What school principal can do to help the school staff working on the application,follow two sections:   
