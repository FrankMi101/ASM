<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SecurityManageSubTeachers.aspx.cs" Inherits="ASM.SecurityManageSubTeachers" Async="true" %>
...
<script type="text/javascript">
    ...
    function SaveDataToDatabase() {
        try {
            ...
            var result = ASM.Models.WebService.SaveSecurityGroupMember("Teachers", para.Operate, para, onSuccess, onFailure);
        }
        catch (e) {
