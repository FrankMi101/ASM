<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Security_Group.aspx.cs" Inherits="ASM.Security_Group" Async="true" %>
...
<script type="text/javascript">
    ...
    function SaveDataToDatabase() {
        try {
            ...
            var result = ASM.Models.WebService.SaveSecurityGroup(para.Operate, para, onSuccess, onFailure);
        }
        catch (e) {
    ...
    function PushAppGroupToAnotherApp() {
        ...
        var result = ASM.Models.WebService.PushGroupToAnotherApp('Push', para, onSuccess, onFailure);
