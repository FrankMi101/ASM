<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SecurityManageSub.aspx.cs" Inherits="ASM.SecurityManageSub" Async="true" %>
    ...
    function OpenGroupMemberActionPage(userID, userRole, schoolYear, schoolCode, appID, groupID, memberID, memberType, actionType) {
        try {
            ...
            if (result) {
                ...
                var result = ASM.Models.WebService.SaveSecurityGroupMember(memberType, actionType, para, onSuccess, onFailure);
            }
        }
        catch (e) {
