...
//     var helptext = ASM.Models.WebService1.GetHelpContent("Read", UserID, CategoryID, AreaID, ItemCode, "Help", onSuccessHelp, onFailure);
...
//    // ItemCode = $(this)[0].id.replace("img_", "");
//    var helptext = ASM.Models.WebService1.GetHelpContent("Read", UserID, CategoryID, AreaID, ItemCode, "EP", onSuccessHelp, onFailure);
...
//    }
//    else {
//        var Helptext = ASM.Models.WebService1.GetHelpContent("Read", UserID, CategoryID, AreaID, ItemCode, "Help", onSuccess21, onFailure);
